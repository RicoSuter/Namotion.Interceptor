...
| #410 | Gap G17 | The deciding code, `ContextInheritanceHandler`, is in Tracking and outside this dossier's boundary; the stranded edge it leaves behind is inside it. PR #322 is the open fix. PR #594 fixes the sibling path G17 also records, a last detach through a different parent, and not this one. |
...
Four pull requests opened on 2026-09-22, each against a gap this document records: three fixes, and #597, a performance change stacked on #596. They are cross-referenced where the gap is described and are not dispositioned or counted here. #596 and #597 bear on [C18](#c18-x1-the-read-terminal-pair)'s ruling without making it, and C18 records how.

| PR | Core files | Targets | What it does to the recorded defect |
|---|---|---|---|
