...
- Transient state changes lost to merging (ChangeQueueProcessor collapses each flush to one change per property within its 8ms buffer window, and drops a commit that a delivered one has already superseded)
