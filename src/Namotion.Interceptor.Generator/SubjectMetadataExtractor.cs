        ...
        foreach (var syntaxReference in typeSymbol.DeclaringSyntaxReferences)
        {
            ...
            foreach (var property in typeDeclarationSyntax.Members.OfType<PropertyDeclarationSyntax>())
            {
                ...
                properties.Add(new PropertyMetadata(
                    ...
                    hasSetter,
                    hasInit,
                    UsesStructuralSetter: PropertyWriteRouting.RequiresStructuralWrite(typeInfo.Type, semanticModel.Compilation),
        ...
        foreach (var interfaceType in typeSymbol.AllInterfaces)
        {
            foreach (var member in interfaceType.GetMembers())
            {
                ...
                interfaceProperties.Add(new PropertyMetadata(
                    ...
                    hasSetter,
                    hasInit,
                    UsesStructuralSetter: PropertyWriteRouting.RequiresStructuralWrite(property.Type, compilation),
