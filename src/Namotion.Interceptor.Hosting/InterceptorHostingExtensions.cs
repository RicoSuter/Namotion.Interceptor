...
public static class InterceptorHostingExtensions
{
    ...
    public static bool AttachHostedService(this IInterceptorSubject subject, IHostedService hostedService)
    {
        ...
        if (wasAdded)
        {
            ...
            // has finished starting" as a completion point would otherwise pass it too early. The
            // awaiting overload needs no hold, because its caller is blocked until the service has
            // started.
