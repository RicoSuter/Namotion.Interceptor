...
public class ReadModeDemotionTests
{
    ...
    [Fact]
    public void GetConfiguredReadMode_ShouldReturnExplicitReadMode()
    {
        // Arrange
        var context = CreateContext();
        var model = new NotificationOnlyModel(context);
    ...
    [Fact]
    public void GetConfiguredReadMode_ShouldReturnDefaultForAutoMode()
    {
        // Arrange
        var context = CreateContext();
        var model = new AutoModeModel(context);
    ...
    [Fact]
    public void GetConfiguredCycleTime_ShouldReturnExplicitCycleTime()
    {
        // Arrange
        var context = CreateContext();
        var model = new NotificationOnlyModel(context);
    ...
    [Fact]
    public void GetConfiguredCycleTime_ShouldReturnDefaultWhenNotSet()
    {
        // Arrange
        var context = CreateContext();
        var model = new AutoModeModel(context);
    ...
    [Fact]
    public void GetConfiguredPriority_ShouldReturnExplicitPriority()
    {
        // Arrange
        var context = CreateContext();
        var model = new DemotionTestModel(context);
    ...
    [Fact]
    public void GetConfiguredPriority_ShouldReturnZeroDefault()
    {
        // Arrange
        var context = CreateContext();
        var model = new AutoModeModel(context);
