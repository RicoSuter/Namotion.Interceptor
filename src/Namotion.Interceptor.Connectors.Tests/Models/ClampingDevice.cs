...
/// <summary>
/// Test model whose OnValueChanging hook clamps the incoming value, used to pin the source
/// semantics of transformed trigger values: a write whose stored value differs from the incoming
/// value publishes as local origin, because the local model computed it (#345).
/// </summary>
[InterceptorSubject]
