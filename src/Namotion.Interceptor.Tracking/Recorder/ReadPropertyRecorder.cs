...
/// The singleton authority for read recording on its context: the active scopes are shared
/// through a static, so a second instance would repeat the recording work for every read.
/// </summary>
