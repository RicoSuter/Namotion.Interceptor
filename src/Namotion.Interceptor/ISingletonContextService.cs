...
/// implement this interface for several contracts and then reserves all of them. Only services
/// registered directly on a context are considered; fallback contexts are not inspected.
/// </summary>
