...
internal interface INonStructuralWriteCompletionCoordinator
{
    Exception? CompleteNonStructuralWrite(Exception? primaryException);
}

internal interface ILogicalContextGuard
{
    void ThrowIfOtherLogicalContext();
}
