...
/// <see cref="FluentPathProvider{TMetadata}"/>-backed node mapper with an <see cref="OpcUaFluentMetadataMapper"/>
...
public sealed class OpcUaFluentMapper : ReverseCompositeMapper<OpcUaPropertyMapping, OpcUaLookupKey>
{
    public OpcUaFluentMapper(FluentMappingRegistry<OpcUaPropertyMapping> registry, char pathSeparator = '.')
        : base(
            new OpcUaPathProviderMapper(new FluentPathProvider<OpcUaPropertyMapping>(registry, pathSeparator)),
