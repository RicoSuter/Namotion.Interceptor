...
/// <summary>
/// Applies the optimistic local echo after a successful bridge command.
///
/// The Hue SDK resources are plain mutable DTOs held behind an intercepted property. Mutating one in
...
/// </summary>
internal static class HueResourceEcho
{
    /// <summary>
