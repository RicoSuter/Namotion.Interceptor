...
internal sealed class InMemoryHistoryStoreCore
{
    ...
    public InMemoryHistoryStoreCore(
        int maxPointsPerProperty, TimeSpan maxAge, int maxJsonSize, Func<DateTimeOffset> getUtcNow)
    {
