...
public static class PathExtensions
{
    ...
    /// <param name="connector">The optional connector to mark the write as coming from this connector to avoid updates.</param>
    /// <returns>The result specifying whether the path could be found and the value has been applied.</returns>
    public static bool UpdatePropertyValueFromSourcePath(this IInterceptorSubject subject, string sourcePath, DateTimeOffset timestamp, object? value, IConnectorPathProvider connectorPathProvider, ISubjectConnector? connector)
    {
        return subject
            .UpdatePropertyValueFromSourcePath(sourcePath, timestamp, (_, _) => value, connectorPathProvider, connector);
    }
    ...
    public static bool UpdatePropertyValueFromSourcePath(this IInterceptorSubject subject,
        ...
        IConnectorPathProvider connectorPathProvider, ISubjectConnector? connector)
    {
        return subject
            .VisitPropertiesFromSourcePathsWithTimestamp([sourcePath], timestamp,
                (property, path, _) => SetPropertyValue(property, timestamp, getPropertyValue(property, path), connector), connectorPathProvider)
            .Count == 1;
    }
    ...
    /// <param name="connector">The optional connector to mark the write as coming from this connector to avoid updates.</param>
    /// <returns></returns>
    public static IEnumerable<string> UpdatePropertyValuesFromSourcePaths(this IInterceptorSubject subject, IEnumerable<string> sourcePaths, DateTimeOffset timestamp, Func<RegisteredSubjectProperty, string, object?> getPropertyValue, IConnectorPathProvider connectorPathProvider, ISubjectConnector? connector)
    {
        return subject
            .VisitPropertiesFromSourcePathsWithTimestamp(sourcePaths, timestamp, (property, path, _) => SetPropertyValue(property, timestamp, getPropertyValue(property, path), connector), connectorPathProvider);
    }
    ...
    public static IEnumerable<string> UpdatePropertyValuesFromSourcePaths(this IInterceptorSubject subject, IReadOnlyDictionary<string, object?> pathsAndValues, DateTimeOffset timestamp, IConnectorPathProvider connectorPathProvider, ISubjectConnector? connector)
    {
        return subject
            .VisitPropertiesFromSourcePathsWithTimestamp(pathsAndValues.Keys, timestamp, (property, path, _) => SetPropertyValue(property, timestamp, pathsAndValues[path], connector), connectorPathProvider);
    }
    ...
    private static IReadOnlyCollection<string> VisitPropertiesFromSourcePathsWithTimestamp(this IInterceptorSubject subject,
        ...
        IConnectorPathProvider connectorPathProvider, ISubjectFactory? subjectFactory = null)
    {
    ...
    private static void SetPropertyValue(RegisteredSubjectProperty property, DateTimeOffset timestamp, object? value, ISubjectConnector? connector)
    {
    ...
    public static string? TryGetSourcePath(this RegisteredSubjectProperty property, IConnectorPathProvider connectorPathProvider, IInterceptorSubject? rootSubject)
    {
    ...
    public static IEnumerable<(string path, RegisteredSubjectProperty property)> GetSourcePaths(
        this IEnumerable<RegisteredSubjectProperty> properties, IConnectorPathProvider connectorPathProvider, IInterceptorSubject? rootSubject)
    {
    ...
    public static IEnumerable<(string path, SubjectPropertyChange change)> GetSourcePaths(
        this IEnumerable<SubjectPropertyChange> changes, IConnectorPathProvider connectorPathProvider, IInterceptorSubject? rootSubject)
    {
    ...
    public static (RegisteredSubjectProperty? property, object? index) TryGetPropertyFromSourcePath(
        this IInterceptorSubject subject, string sourcePath, IConnectorPathProvider connectorPathProvider, ISubjectFactory? subjectFactory = null)
    {
